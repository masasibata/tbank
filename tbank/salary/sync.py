...
class SalaryClient(BaseSyncClient):
    ...
    def add_employees_by_requisites(
        ...
        return self._initiate(_P_ADD_EMPLOYEES, request, secured=False)
    ...
    def create_employees(self, request: CreateEmployeesRequest) -> str:
        ...
        return self._initiate(_P_CREATE_EMPLOYEES, request, secured=False)
    ...
    def list_employees(self, request: ListEmployeesRequest) -> ListEmployeesResult:
        ...
        return self._call(_LIST_EMPLOYEES, request)
    ...
    def create_and_submit_registry(self, request: CreateSubmitRegistryRequest) -> str:
        ...
        return self._initiate(_P_CREATE_SUBMIT, request, secured=True)
    ...
    def submit_payment_registry(
        ...
        return self._initiate(_P_SUBMIT, request, secured=True)
    ...
    def pay_payment_registry(self, request: PayRegistryRequest) -> str:
        ...
        response = transport.request("POST", _P_PAY, json=payload)
        self._raise_for_http(response)
        return request.id
    ...
    def cancel_payment_registry(
        ...
        return self._initiate(_P_CANCEL, request, secured=True)

    def get_cancel_result(self, correlation_id: str) -> CancelResult:
        """Результат отмены отправки реестра (mTLS)."""
        return self._call(_CANCEL_RESULT, CorrelationRef(correlation_id=correlation_id))
