...
class TidClient(BaseAsyncClient):
    ...
    async def get_passport(
        ...
        return await self._get(_PASSPORT_PATH, PassportData, params=params)
    ...
    async def get_addresses(
        ...
        return await self._get(_ADDRESSES_PATH, AddressesResponse, params=params)
    ...
    async def get_cobrand(self, program_id: int) -> CobrandResponse:
        ...
        return await self._get(_cobrand_path(program_id), CobrandResponse)
    ...
    async def get_personal_data(self, request_id: str) -> IdentificationData:
        ...
        return await self._get(_personal_data_path(request_id), IdentificationData)
